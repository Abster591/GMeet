...
navigator.mediaDevices
  ...
  }).then(()=>{videoToggle.addEventListener('click',toggleVideo)}).then(()=>{audioToggle.addEventListener('click',toggleAudio)}).then(()=>{myVideo.srcObject.getAudioTracks()[0].enabled = false;});
